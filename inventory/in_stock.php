...
$queryInStock = "SELECT * FROM equipment WHERE status = 'In Stock'";
...
<head>
    ...
    <title>In Stock Equipment</title>
...
<body>
    ...
    <div class="mt-5 ml-4" style="margin-right: 280px;">
        <h1 class="text-center">In Stock Equipment</h1>
        <hr>
        ...
        <table class="table table-sm">
            ...
            <tbody>
                <?php if (mysqli_num_rows($resultInStock) > 0) : ?>
                    <?php while ($row = mysqli_fetch_assoc($resultInStock)) : ?>
                        <tr>
                            ...
                            <td>
                                <a href='manage_equipment.php?equipment_id=<?php echo $row['equipment_id']; ?>&action=redeploy' class='btn btn-sm btn-primary'>Deploy</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else : ?>
